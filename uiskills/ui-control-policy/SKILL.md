...
2. **Manual ADB tools** (`adb shell <command>`), only when agent mode fails or is unsafe.

## Decision Procedure (Strict)
1. Consult `skills/ui-capabilities/SKILL.md`.
